...
final List<Repair> repairs = [
  Repair(
    ...
    + "f the rim tape needs repairing/reinforcing then you can use any tape available as a temporary fix, but it may not hold up to high pressure for a long time.", 
